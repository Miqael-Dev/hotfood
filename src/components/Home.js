...
import { Badge, Rating, FormControl, NativeSelect, InputLabel } from "@mui/material";
      ...
      >
        <div className="openClose">
          ...
          <table>
            <th colSpan={2}>
              <h2>
                <span style={{ color: "white" }}>Hot</span>
                <span style={{ color: "rgb(254,192,87)" }}>Food</span>
              </h2>
              <p className="contactInfo">
                <FontAwesomeIcon icon={faPhone} />
                +233 59 959 9317 | name@mail.com
              </p>
              <h2 className="openTitle">
                <center>OPENING TIMES</center>
              </h2>
            </th>
            <tr>
              <td>Monday</td>
        ...
        <section className="sectionOne">
          <div className="navBar">
            <motion.div
              ...
              transition={{ type: "spring", duration: 1.5, stiffness: 110 }}
            >
              <Link to="/">
